export const presetVinicuncaTargets: string[] = [
  // align
  'vertical-baseline',
  'vertical-super',
  'align-text-bottom',
  ...
  'selection:text-[var(--select-color)]',
  ...
  'open:text-pink-100',
  'in-range:text-pink-100',
  'out-of-range:text-pink-100',
...
export const presetVinicuncaNonTargets = [
