...
describe('color utils', () => {
  ...
  it('parses shadow color values', () => {
    ...
    // full box-shadow
    expect(colorableShadows('var(--vin-shadow-inset) 0 1px 3px 0 #0000', '--v')).eql(['var(--vin-shadow-inset) 0 1px 3px 0 var(--v, rgba(0,0,0,0))']);
  ...
  it('parses color token', () => {
    ...
    expect(fn('info')).eql({
      '--vin-v-opacity': 1,
      'prop': 'hsla(200.1,100%,54.3%,var(--vin-v-opacity))',
    });
    ...
    expect(fn('warning')).eql({
      '--vin-v-opacity': 1,
      'prop': 'hsla(42.4,100%,50%,var(--vin-v-opacity))',
    });
    ...
    expect(fn('danger')).eql({
      '--vin-v-opacity': 1,
      'prop': 'hsla(var(--danger),var(--vin-v-opacity))',
    });
